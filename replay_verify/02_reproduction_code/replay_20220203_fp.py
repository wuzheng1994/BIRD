#!/usr/bin/env python3
# Standalone replay for 20220203_fp; this file intentionally contains the full BGPy replay engine.
# Event type: Type-1 S|1 forged-origin hijack (FP candidate); prefix: 121.53.104.0/24.
# Attacker A=AS6461 seeds as_path=(A, V) with forged origin V=AS9457.
# Pre-event legal origin for the realistic counterfactual: AS9457 on covering 121.53.0.0/16.
...
CONFIG = EventConfig(
    event_id='20220203_fp',
    event_name='Type-1 FP more-specific event 20220203_fp',
    anomaly_type='hijack',
    canonical_prefix='121.53.104.0/24',
    root_asn=6461,
    victim_asn=9457,
