#!/usr/bin/env python3
# Standalone replay for 20251203_1907; this file intentionally contains the full BGPy replay engine.
# Event type: recovery; prefix: 87.229.125.0/24; root AS: 834.
# Evidence summary: AS 834 hijacked prefix 87.229.125.0/24. The legitimate origin is AS 214025, but AS 834 is announcing this prefix.
...
CONFIG = EventConfig(
    event_id='20251203_1907',
    event_name='Recovery event 20251203_1907',
    anomaly_type='recovery',
    canonical_prefix='87.229.125.0/24',
    root_asn=834,
    victim_asn=214025,
