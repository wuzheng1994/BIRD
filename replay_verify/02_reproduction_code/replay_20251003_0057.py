#!/usr/bin/env python3
# Standalone replay for 20251003_0057; this file intentionally contains the full BGPy replay engine.
# Event type: hijack; prefix: 150.241.121.0/24; root AS: 401152.
# Evidence summary: AS 401152 hijacked prefix 150.241.121.0/24. The legitimate origin is AS 20473, but AS 401152 is announcing this prefix.
...
CONFIG = EventConfig(
    event_id='20251003_0057',
    event_name='Hijack event 20251003_0057',
    anomaly_type='hijack',
    canonical_prefix='150.241.121.0/24',
    root_asn=401152,
    victim_asn=20473,
    caida_snapshot=datetime(2025, 10, 1),
)
