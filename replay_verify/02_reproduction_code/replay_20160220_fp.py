#!/usr/bin/env python3
# Standalone replay for 20160220_fp; this file intentionally contains the full BGPy replay engine.
# Event type: Type-1 S|1 forged-origin hijack (FP candidate); prefix: 72.20.0.0/24.
# Attacker A=AS134830 seeds as_path=(A, V) with forged origin V=AS203959.
# Pre-event legal origin for the realistic counterfactual: AS25761 on covering 72.20.0.0/19.
...
CONFIG = EventConfig(
    event_id='20160220_fp',
    event_name='Type-1 FP more-specific event 20160220_fp',
    anomaly_type='hijack',
    canonical_prefix='72.20.0.0/24',
    root_asn=134830,
    victim_asn=25761,
