#!/usr/bin/env python3
# Standalone replay for 20251202_1826; this file intentionally contains the full BGPy replay engine.
# Event type: leak; prefix: 182.160.124.0/24; root AS: 139009.
# Evidence summary: No definitive anomaly detected. The AS path changed from '202365 50673 9498 139009 24323' to '202365 6939 139009 24323', but no abnormal business relationship patterns were found. The origin AS (24323) remains the legitimate owner of the prefix. This appears to be a normal routing change where the path switched from AS 50673 → AS 9498 to AS 6939 directly.
...
CONFIG = EventConfig(
    event_id='20251202_1826',
    event_name='Leak event 20251202_1826',
    anomaly_type='leak',
    canonical_prefix='182.160.124.0/24',
    root_asn=139009,
    victim_asn=None,
