#!/usr/bin/env python3
# Standalone replay for 20251114_0017; this file intentionally contains the full BGPy replay engine.
# Event type: leak; prefix: 103.197.167.0/24; root AS: 7642.
# Evidence summary: Route leak detected involving AS 45489. Analysis of AS relationships shows abnormal triplets: 1) 7642 (provider) -> 45489 (customer) -> 24016 (provider) violates valley-free routing (customer-to-provider followed by provider-to-customer). 2) 6894 (peer) -> 6939 (customer) -> 7642 (provider) shows peer-to-peer leak. The legitimate origin AS 24016 remains unchanged, confirming this is not a prefix hijack.
...
CONFIG = EventConfig(
    event_id='20251114_0017',
    event_name='Leak event 20251114_0017',
    anomaly_type='leak',
    canonical_prefix='103.197.167.0/24',
    root_asn=7642,
    victim_asn=None,
