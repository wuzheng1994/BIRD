#!/usr/bin/env python3
# Standalone replay for 7-20160416_fp; this file intentionally contains the full BGPy replay engine.
# Event type: Type-1 S|1 forged-origin hijack (FP candidate); prefix: 161.123.172.0/24.
# Attacker A=AS203959 seeds as_path=(A, V) with forged origin V=AS27176.
# Pre-event legal origin for the realistic counterfactual: AS12586.
...
CONFIG = EventConfig(
    event_id='7-20160416_fp',
    event_name='Type-1 FP more-specific event 7-20160416_fp',
    anomaly_type='hijack',
    canonical_prefix='161.123.172.0/24',
    root_asn=203959,
    victim_asn=12586,
