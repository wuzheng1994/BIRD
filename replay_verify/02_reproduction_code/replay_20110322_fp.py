#!/usr/bin/env python3
# Standalone replay for 20110322_fp; this file intentionally contains the full BGPy replay engine.
# Event type: Type-1 E|1 forged-origin hijack (FP candidate); prefix: 69.171.255.0/24.
# Attacker A=AS9318 seeds as_path=(A, V) with forged origin V=AS32934.
# Pre-event legal origin for the realistic counterfactual: AS32934 (origin unchanged).
...
CONFIG = EventConfig(
    event_id='20110322_fp',
    event_name='Type-1 FP exact-prefix event 20110322_fp',
    anomaly_type='hijack',
    canonical_prefix='69.171.255.0/24',
    root_asn=9318,
    victim_asn=32934,
    caida_snapshot=datetime(2008, 2, 1),
)
