#!/usr/bin/env python3
# Standalone replay for 20251121_0301; this file intentionally contains the full BGPy replay engine.
# Event type: recovery; prefix: 206.162.244.0/24; root AS: 834.
# Evidence summary: AS 834 hijacked prefix 206.162.244.0/24. The legitimate origin is AS 53850, but AS 834 is announcing this prefix. Analysis of the highest-scored path changes shows the origin AS changed from 53850 to 834 in multiple observed paths after the anomaly event.
...
CONFIG = EventConfig(
    event_id='20251121_0301',
    event_name='Recovery event 20251121_0301',
    anomaly_type='recovery',
    canonical_prefix='206.162.244.0/24',
    root_asn=834,
    victim_asn=53850,
