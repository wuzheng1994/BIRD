#!/usr/bin/env python3
# Standalone replay for 20150612_0843; this file intentionally contains the full BGPy replay engine.
# Event type: leak; prefix: 91.213.204.0/24; root AS: 4788.
# Evidence summary: AS 4788 leaked routes from its provider AS 3549 to its peer AS 1257, violating the valley-free routing principle. The original path 3549 1239 1257 8437 39393 (peer-to-customer relationship) was replaced with 3549 4788 1257 8437 39393 where AS 4788 (a customer of AS 3549) improperly announced provider routes to its peer AS 1257.
...
CONFIG = EventConfig(
    event_id='20150612_0843',
    event_name='Leak event 20150612_0843',
    anomaly_type='leak',
    canonical_prefix='91.213.204.0/24',
    root_asn=4788,
    victim_asn=None,
    caida_snapshot=datetime(2015, 6, 1),
)
