#!/usr/bin/env python3
# Standalone replay for 20140926_fp; this file intentionally contains the full BGPy replay engine.
# Event type: Type-1 exact-prefix forged-origin hijack (FP candidate); prefix: 200.239.0.0/18.
# Attacker A=AS6461 seeds as_path=(A, V) with forged origin V=AS1273.
# Pre-event legal origin for the realistic counterfactual: AS11888.
...
CONFIG = EventConfig(
    event_id='20140926_fp',
    event_name='Type-1 FP exact-prefix forged-origin hijack 20140926_fp',
    anomaly_type='hijack',
    canonical_prefix='200.239.0.0/18',
    root_asn=6461,
    victim_asn=11888,
    caida_snapshot=datetime(2014, 9, 1),
)
